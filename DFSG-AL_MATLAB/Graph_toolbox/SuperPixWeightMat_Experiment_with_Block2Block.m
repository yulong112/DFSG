%% load data
function [WeightMat,nodes_to_add] = SuperPixWeightMat_Experiment_with_Block2Block(HyperCube, superpix_img, param2, flag2)
...
%     for i = 1:N
%         if strcmp(param2,'DIST')||strcmp(param2,'DIST2')||strcmp(param2,'DIST3')
%             nodes_to_knn(i, distance(i,:) > knn_distance(i) ) = false;
%         else
%             nodes_to_knn(i, distance(i,:) < knn_distance(i) ) = false;
%         end
%         nodes_to_knn(i,i) = false; % diagonal should be zero
%     end
%     nodes_to_knn( nodes_to_knn ~= nodes_to_knn' ) = false;
...
%     
%     if strcmp(flag2,'knn')
%         nodes_to_retain = nodes_to_retain|nodes_to_knn;
%     elseif strcmp(flag2,'nn')
%         nodes_to_retain = nodes_to_retain|nodes_to_nn;
%     elseif strcmp(flag2,'combine')
%         nodes_to_retain = nodes_to_retain|nodes_to_knn|nodes_to_nn;
%     end
...
%     nodes_to_add = Connect_pixel_btwsp(nodes_to_super,superpix_img, distance, param2, flag2);
    nodes_to_add = Connect_pixel_btwsp2(nodes_to_super,superpix_img, distance, param2);
