function [TrainSam,TestSam,TrainLabels,TestLabels,TrainSamLoc,TestSamLoc] = ...
    fSetTrainTestSam_Neighbor_V1(HyperData,TruthMap,SelClassNo,NeighborMask,RandNo,TrainSamNum,TestSamNum)
%%%%%%%%%%%%%%%%
...
for i = 1:length(ClassNo)
    LabelOneClass = find(Label1D == i);%%!!!%LabelOneClass为编号为i-1的位置
